...
static bool _parse_pinbase(struct probe_controls* controls, char* s) {
    if (s == NULL) {
...
static bool parse_pinwidth(struct probe_controls* controls, char* s) {
    if (s == NULL) {
...
static bool parse_frequency(struct probe_controls* controls, char* s) {
    if (s == NULL) {
...
static bool parse_startenabled(struct probe_controls* controls, char* s) {
    if (s == NULL) {
...
static bool parse_startpin(struct probe_controls* controls, char* s) {
    if (s == NULL) {
...
static bool parse_starttrigger(struct probe_controls* controls, char* s) {
    if (s == NULL) {
...
static bool parse_eventenabled(struct probe_controls* controls, char* s) {
    if (s == NULL) {
...
static bool parse_eventpin(struct probe_controls* controls, char* s) {
    if (s == NULL) {
...
static bool parse_eventtrigger(struct probe_controls* controls, char* s) {
    if (s == NULL) {
...
static bool parse_sampleendmode(struct probe_controls* controls, char* s) {
    if (s == NULL) {
...
static bool parse_samplesize(struct probe_controls* controls, char* s) {
    if (s == NULL) {
...
bool parse_pinbase(struct probe_controls* controls, char* s) {
    return _parse_pinbase(controls,s);
}
